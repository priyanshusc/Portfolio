  ...
  return (
    <div className="group rounded-2xl border border-white/10 bg-card/60 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:scale-102 hover:shadow-neon-purple-light">
      <div className="relative hover:scale-105 transition-all duration-300">
        <img src={p.image} alt={p.title} className="h-44 w-full object-cover object-top" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
      </div>
      <div className="p-4">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-lg">{p.title}</h3>
          <a href={p.href} target="_blank" className="text-neon-purple hover:text-white inline-flex items-center gap-1 text-sm">
